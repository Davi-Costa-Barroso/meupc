...
function corrigir() {
    ...
    if (num >= 4) {
      seguir.innerHTML = "Muito bem, passe para o proximo nivel <a href=quiz2.html><button id=nivel2>Nivel 2</button></a>";
    }
    else{
      seguir.innerHTML = "Que pena, acerte no minimo 4 questões para subir de nivel";
    }
}